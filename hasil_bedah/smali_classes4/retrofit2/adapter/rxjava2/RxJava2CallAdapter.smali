...
# direct methods
.method constructor <init>(Ljava/lang/reflect/Type;LcreateFromFileString;ZZZZZZZ)V
    .locals 0
    ...
    .line 50
    iput-object p2, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:LcreateFromFileString;
...
.method public final adapt(Lretrofit2/Call;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/ResultObservable;-><init>(LContextUtilApi30Impl;)V
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/BodyObservable;-><init>(LContextUtilApi30Impl;)V
    ...
    :cond_2
    :goto_2
    iget-object p1, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:LcreateFromFileString;

    if-eqz p1, :cond_3

    .line 80
    invoke-virtual {v0, p1}, LContextUtilApi30Impl;->subscribeOn(LcreateFromFileString;)LContextUtilApi30Impl;
    ...
    .line 84
    sget-object p1, Lio/reactivex/BackpressureStrategy;->TuitionPaymentFragmentbindingInflater1:Lio/reactivex/BackpressureStrategy;

    invoke-virtual {v0, p1}, LContextUtilApi30Impl;->toFlowable(Lio/reactivex/BackpressureStrategy;)LCloseGuardHelper;
    ...
    .line 87
    invoke-virtual {v0}, LContextUtilApi30Impl;->singleOrError()LconvertToExifDateTime;
    ...
    .line 90
    invoke-virtual {v0}, LContextUtilApi30Impl;->singleElement()LCloseGuardHelperCloseGuardImpl;
    ...
    .line 93
    invoke-virtual {v0}, LContextUtilApi30Impl;->ignoreElements()LwriteShort;
