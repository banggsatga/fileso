...
.method constructor <init>(LgetSessionOptionUnpacker;)V
    ...
    .line 32
    iput-object p1, p0, Lretrofit2/converter/moshi/MoshiRequestBodyConverter;->adapter:LgetSessionOptionUnpacker;
...
.method public final convert(Ljava/lang/Object;)Lokhttp3/RequestBody;
    ...
    .line 1167
    new-instance v1, LUseCaseConfigFactory;

    invoke-direct {v1, v0}, LUseCaseConfigFactory;-><init>(LgetSharingNode;)V

    .line 38
    iget-object v2, p0, Lretrofit2/converter/moshi/MoshiRequestBodyConverter;->adapter:LgetSessionOptionUnpacker;

    invoke-virtual {v2, v1, p1}, LgetSessionOptionUnpacker;->b(LUseCaseConfigBuilder;Ljava/lang/Object;)V
