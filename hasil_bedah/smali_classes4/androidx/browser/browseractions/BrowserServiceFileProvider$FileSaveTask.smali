...
.method private saveFileBlocking(Ljava/io/File;)V
    ...
    invoke-virtual {v1, v2}, Landroidx/concurrent/futures/AbstractResolvableFuture;->set(Ljava/lang/Object;)Z
    :try_end_1
    ...
    invoke-virtual {p1, v1}, Landroidx/concurrent/futures/AbstractResolvableFuture;->setException(Ljava/lang/Throwable;)Z
...
.method private saveFileIfNeededBlocking()V
    ...
    invoke-virtual {v0, v2}, Landroidx/concurrent/futures/AbstractResolvableFuture;->setException(Ljava/lang/Throwable;)Z
    :try_end_0
    ...
    invoke-virtual {v0, v3}, Landroidx/concurrent/futures/AbstractResolvableFuture;->set(Ljava/lang/Object;)Z
