...
.field private mService:LonConnectionFailed;

.field private final mSessionBinder:Lsubscribe;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lsubscribe;
...
.method private isBoundToService()Z
    ...
    .line 106
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:LonConnectionFailed;
...
.method private notifyMessageChannelReadyInternal(Landroid/os/Bundle;)Z
    ...
    .line 167
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:LonConnectionFailed;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lsubscribe;

    invoke-interface {v2, v3, p1}, LonConnectionFailed;->onMessageChannelReady(Lsubscribe;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 122
    invoke-static {p2}, LonConnectionFailed$TuitionPaymentFragmentspecialinlinedviewModeldefault3;->asInterface(Landroid/os/IBinder;)LonConnectionFailed;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:LonConnectionFailed;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, LonConnectionFailed;->onPostMessage(Lsubscribe;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
