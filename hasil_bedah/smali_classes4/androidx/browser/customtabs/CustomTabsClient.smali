...
# direct methods
.method constructor <init>(LonConnectionSuspended;Landroid/content/ComponentName;Landroid/content/Context;)V
    .locals 0
    ...
    .line 57
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:LonConnectionSuspended;
...
.method private createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Lsubscribe$TuitionPaymentFragmentspecialinlinedviewModeldefault3;
    .locals 1
...
.method private newSessionInternal(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    .line 290
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsClient;->createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Lsubscribe$TuitionPaymentFragmentspecialinlinedviewModeldefault3;
    ...
    .line 298
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:LonConnectionSuspended;

    invoke-interface {v2, p1, v1}, LonConnectionSuspended;->newSessionWithExtras(Lsubscribe;Landroid/os/Bundle;)Z
    ...
    .line 300
    :cond_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:LonConnectionSuspended;

    invoke-interface {v1, p1}, LonConnectionSuspended;->newSession(Lsubscribe;)Z
    ...
    invoke-direct {v0, v1, p1, v2, p2}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(LonConnectionSuspended;Lsubscribe;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 317
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:LonConnectionSuspended;

    invoke-interface {v0, p1, p2}, LonConnectionSuspended;->extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public warmup(J)Z
    ...
    invoke-interface {v0, p1, p2}, LonConnectionSuspended;->warmup(J)Z
