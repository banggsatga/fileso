...
# instance fields
.field private final mCallback:Lsubscribe;
...
.field private final mService:LonConnectionSuspended;


# direct methods
.method constructor <init>(LonConnectionSuspended;Lsubscribe;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    .line 87
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LonConnectionSuspended;

    .line 88
    iput-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)LonConnected$b;
    .locals 1
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)LonConnected$b;
    .locals 1
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(LonConnectionSuspended;Lsubscribe;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method final getBinder()Landroid/os/IBinder;
    ...
    .line 515
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {v0}, Lsubscribe;->asBinder()Landroid/os/IBinder;
...
.method final getId()Landroid/app/PendingIntent;
    .locals 1
...
.method public final isEngagementSignalsApiAvailable(Landroid/os/Bundle;)Z
    ...
    .line 358
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LonConnectionSuspended;

    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {v0, v1, p1}, LonConnectionSuspended;->isEngagementSignalsApiAvailable(Lsubscribe;Landroid/os/Bundle;)Z
...
.method public final mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    invoke-interface {v0, v1, p1, p2, p3}, LonConnectionSuspended;->mayLaunchUrl(Lsubscribe;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 275
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LonConnectionSuspended;

    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {v1, v2, p1, p2}, LonConnectionSuspended;->postMessage(Lsubscribe;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public final receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    .locals 2
    ...
    invoke-interface {v0, v1, p1, p2, p3}, LonConnectionSuspended;->receiveFile(Lsubscribe;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public final requestPostMessageChannel(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 1
    ...
    .line 248
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LonConnectionSuspended;

    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {p2, v0, p1, p3}, LonConnectionSuspended;->requestPostMessageChannelWithExtras(Lsubscribe;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {p2, p3, p1}, LonConnectionSuspended;->requestPostMessageChannel(Lsubscribe;Landroid/net/Uri;)Z
...
.method public final setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-interface {p2, v0, p1}, LonConnectionSuspended;->updateVisuals(Lsubscribe;Landroid/os/Bundle;)Z
...
.method public final setEngagementSignalsCallback(Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 386
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)LonConnected$b;
    ...
    invoke-interface {p1}, LonConnected;->asBinder()Landroid/os/IBinder;

    move-result-object p1

    invoke-interface {v0, v1, p1, p2}, LonConnectionSuspended;->setEngagementSignalsCallback(Lsubscribe;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public final setEngagementSignalsCallback(Ljava/util/concurrent/Executor;Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 439
    invoke-direct {p0, p2, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)LonConnected$b;
    ...
    invoke-interface {p2, v0, p1, p3}, LonConnectionSuspended;->setEngagementSignalsCallback(Lsubscribe;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public final setSecondaryToolbarSwipeUpGesture(Landroid/app/PendingIntent;)Z
    .locals 2
    ...
    .line 181
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LonConnectionSuspended;

    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {p1, v1, v0}, LonConnectionSuspended;->updateVisuals(Lsubscribe;Landroid/os/Bundle;)Z
...
.method public final setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lsubscribe;

    invoke-interface {p1, p2, v0}, LonConnectionSuspended;->updateVisuals(Lsubscribe;Landroid/os/Bundle;)Z
...
.method public final setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-interface {p2, p3, p1}, LonConnectionSuspended;->updateVisuals(Lsubscribe;Landroid/os/Bundle;)Z
...
.method public final validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v1, p1, p2, p3}, LonConnectionSuspended;->validateRelationship(Lsubscribe;ILandroid/net/Uri;Landroid/os/Bundle;)Z
