...
.field private final mService:LMediaBrowserCompatConnectionCallback;


# direct methods
.method constructor <init>(LMediaBrowserCompatConnectionCallback;Landroid/content/ComponentName;)V
    .locals 0
    ...
    .line 67
    iput-object p1, p0, Landroidx/browser/trusted/TrustedWebActivityServiceConnection;->mService:LMediaBrowserCompatConnectionCallback;
...
.method private static wrapCallback(Landroidx/browser/trusted/TrustedWebActivityCallback;)LsetInternalConnectionCallback;
    .locals 1
...
.method public final areNotificationsEnabled(Ljava/lang/String;)Z
    ...
    .line 80
    iget-object v0, p0, Landroidx/browser/trusted/TrustedWebActivityServiceConnection;->mService:LMediaBrowserCompatConnectionCallback;

    invoke-interface {v0, p1}, LMediaBrowserCompatConnectionCallback;->areNotificationsEnabled(Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final cancel(Ljava/lang/String;I)V
    ...
    .line 110
    iget-object p2, p0, Landroidx/browser/trusted/TrustedWebActivityServiceConnection;->mService:LMediaBrowserCompatConnectionCallback;

    invoke-interface {p2, p1}, LMediaBrowserCompatConnectionCallback;->cancelNotification(Landroid/os/Bundle;)V

    return-void
.end method

.method public final getActiveNotifications()[Landroid/os/Parcelable;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v0}, LMediaBrowserCompatConnectionCallback;->getActiveNotifications()Landroid/os/Bundle;
...
.method public final getSmallIconBitmap()Landroid/graphics/Bitmap;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v0}, LMediaBrowserCompatConnectionCallback;->getSmallIconBitmap()Landroid/os/Bundle;
...
.method public final getSmallIconId()I
    ...
    invoke-interface {v0}, LMediaBrowserCompatConnectionCallback;->getSmallIconId()I
...
.method public final notify(Ljava/lang/String;ILandroid/app/Notification;Ljava/lang/String;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {p2, p1}, LMediaBrowserCompatConnectionCallback;->notifyNotificationWithChannel(Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;)Landroid/os/Bundle;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 182
    invoke-static {p3}, Landroidx/browser/trusted/TrustedWebActivityServiceConnection;->wrapCallback(Landroidx/browser/trusted/TrustedWebActivityCallback;)LsetInternalConnectionCallback;
    ...
    .line 183
    :cond_0
    invoke-interface {p3}, LsetInternalConnectionCallback;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {v0, p1, p2, p3}, LMediaBrowserCompatConnectionCallback;->extraCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/IBinder;)Landroid/os/Bundle;
