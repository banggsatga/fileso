...
.method static synthetic lambda$initializeRecording$4(Landroidx/camera/video/MediaStoreOutputOptions;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 3177
    :cond_1
    const-string p0, "Skipping media scanner scan. Unable to retrieve file path from URI: "
...
.method initializeRecording(Landroid/content/Context;)V
    ...
    invoke-direct {v2, v0, p1}, Landroidx/camera/video/Recorder$RecordingRecord$$ExternalSyntheticLambda2;-><init>(Landroidx/camera/video/MediaStoreOutputOptions;Landroid/content/Context;)V
...
.method performOneTimeAudioSourceCreation(Landroidx/camera/video/internal/audio/AudioSettings;Ljava/util/concurrent/Executor;)Landroidx/camera/video/internal/audio/AudioSource;
    ...
    const-string p2, "One-time audio source creation has already occurred for recording "
    ...
    const-string p2, "Recording does not have audio enabled. Unable to create audio source for recording "
