...
# virtual methods
.method final getCurrentAudioStream()Landroidx/camera/video/internal/audio/AudioStream;
    .locals 1
...
.method final isStartRetryIntervalReached()Z
    .locals 7
...
.method final synthetic lambda$mute$7$androidx-camera-video-internal-audio-AudioSource(Z)V
    .locals 2
...
.method final synthetic lambda$postMaxAmplitude$11$androidx-camera-video-internal-audio-AudioSource(Landroidx/camera/video/internal/audio/AudioSource$AudioSourceCallback;)V
    .locals 2
...
.method final synthetic lambda$release$4$androidx-camera-video-internal-audio-AudioSource(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 3
...
.method final synthetic lambda$release$5$androidx-camera-video-internal-audio-AudioSource(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method final synthetic lambda$setAudioSourceCallback$6$androidx-camera-video-internal-audio-AudioSource(Ljava/util/concurrent/Executor;Landroidx/camera/video/internal/audio/AudioSource$AudioSourceCallback;)V
    .locals 1
...
.method final synthetic lambda$setBufferProvider$0$androidx-camera-video-internal-audio-AudioSource(Landroidx/camera/video/internal/BufferProvider;)V
    .locals 2
...
.method final synthetic lambda$start$1$androidx-camera-video-internal-audio-AudioSource()V
    .locals 1
...
.method final synthetic lambda$start$2$androidx-camera-video-internal-audio-AudioSource(Z)V
    .locals 2
...
.method final synthetic lambda$stop$3$androidx-camera-video-internal-audio-AudioSource()V
    .locals 2
...
.method final notifyError(Ljava/lang/Throwable;)V
    .locals 3
...
.method final notifySuspended(Z)V
    .locals 3
...
.method final overrideBySilence(Ljava/nio/ByteBuffer;I)V
    .locals 3
...
.method final postMaxAmplitude(Ljava/nio/ByteBuffer;)V
    .locals 6
...
.method final retryStartAudioStream()V
    .locals 3
...
.method public final setAudioSourceCallback(Ljava/util/concurrent/Executor;Landroidx/camera/video/internal/audio/AudioSource$AudioSourceCallback;)V
    .locals 2
...
.method public final setBufferProvider(Landroidx/camera/video/internal/BufferProvider;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method final setState(Landroidx/camera/video/internal/audio/AudioSource$InternalState;)V
    .locals 2
...
.method final updateSendingAudio()V
    .locals 2
