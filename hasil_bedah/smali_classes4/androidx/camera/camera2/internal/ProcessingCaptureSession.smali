...
.method final issueStillCaptureRequest(Landroidx/camera/core/impl/CaptureConfig;)V
    .locals 6
    ...
    .line 433
    new-instance v4, Landroidx/camera/camera2/internal/ProcessingCaptureSession$CaptureCallbackAdapter;
    ...
    invoke-direct {v4, v3, p1, v5}, Landroidx/camera/camera2/internal/ProcessingCaptureSession$CaptureCallbackAdapter;-><init>(ILjava/util/List;Landroidx/camera/camera2/internal/ProcessingCaptureSession$1;)V

    .line 430
    invoke-interface {v0, v1, v2, v4}, Landroidx/camera/core/impl/SessionProcessor;->startCapture(ZLandroidx/camera/core/impl/TagBundle;Landroidx/camera/core/impl/SessionProcessor$CaptureCallback;)I

    return-void
.end method

.method final issueTriggerRequest(Landroidx/camera/core/impl/CaptureConfig;)V
    .locals 6
    ...
    .line 340
    invoke-interface {v1, v0, v2, v4}, Landroidx/camera/core/impl/SessionProcessor;->startTrigger(Landroidx/camera/core/impl/Config;Landroidx/camera/core/impl/TagBundle;Landroidx/camera/core/impl/SessionProcessor$CaptureCallback;)I
...
.method final synthetic lambda$open$0$androidx-camera-camera2-internal-ProcessingCaptureSession(Landroidx/camera/core/impl/DeferrableSurface;)V
    .locals 1
...
.method final synthetic lambda$open$2$androidx-camera-camera2-internal-ProcessingCaptureSession(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSession$Opener;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 9
...
.method final synthetic lambda$open$3$androidx-camera-camera2-internal-ProcessingCaptureSession(Ljava/lang/Void;)Ljava/lang/Void;
    .locals 0
...
.method final synthetic lambda$release$4$androidx-camera-camera2-internal-ProcessingCaptureSession()V
    .locals 2
...
.method final onConfigured(Landroidx/camera/camera2/internal/CaptureSession;)V
    .locals 2
    ...
    .line 528
    :cond_0
    iget-object v0, p0, Landroidx/camera/camera2/internal/ProcessingCaptureSession;->mProcessorSessionConfig:Landroidx/camera/core/impl/SessionConfig;
    ...
    invoke-static {v0}, Landroidx/camera/camera2/internal/ProcessingCaptureSession;->getSessionProcessorSurfaceList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    invoke-direct {v1, p1, v0}, Landroidx/camera/camera2/internal/Camera2RequestProcessor;-><init>(Landroidx/camera/camera2/internal/CaptureSession;Ljava/util/List;)V

    iput-object v1, p0, Landroidx/camera/camera2/internal/ProcessingCaptureSession;->mRequestProcessor:Landroidx/camera/camera2/internal/Camera2RequestProcessor;
