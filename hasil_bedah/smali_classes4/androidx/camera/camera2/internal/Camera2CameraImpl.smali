...
.method private addOrRemoveMeteringRepeatingUseCase()V
    ...
    .line 1164
    new-instance v2, Landroidx/camera/camera2/internal/MeteringRepeatingSession;
    ...
    invoke-direct {v2, v0, v3, v4}, Landroidx/camera/camera2/internal/MeteringRepeatingSession;-><init>(Landroidx/camera/camera2/internal/compat/CameraCharacteristicsCompat;Landroidx/camera/camera2/internal/DisplayInfoManager;Landroidx/camera/camera2/internal/MeteringRepeatingSession$SurfaceResetCallback;)V

    iput-object v2, p0, Landroidx/camera/camera2/internal/Camera2CameraImpl;->mMeteringRepeatingSession:Landroidx/camera/camera2/internal/MeteringRepeatingSession;
...
.method final debugLog(Ljava/lang/String;)V
    .locals 1
...
.method final findSessionConfigForSurface(Landroidx/camera/core/impl/DeferrableSurface;)Landroidx/camera/core/impl/SessionConfig;
    .locals 3
...
.method public final getCameraAvailability()Landroidx/camera/camera2/internal/Camera2CameraImpl$CameraAvailability;
    .locals 1
...
.method final isMeteringRepeatingAttached()Z
    .locals 3
...
.method final isSessionCloseComplete()Z
    .locals 1
...
.method final isUseCaseAttached(Landroidx/camera/core/UseCase;)Z
    .locals 2
...
.method final synthetic lambda$addOrRemoveMeteringRepeatingUseCase$17$androidx-camera-camera2-internal-Camera2CameraImpl()V
    .locals 7
...
.method final synthetic lambda$attachUseCases$15$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/util/List;)V
    .locals 1
...
.method final synthetic lambda$configAndCloseIfNeeded$0$androidx-camera-camera2-internal-Camera2CameraImpl()V
    .locals 3
...
.method final synthetic lambda$detachUseCases$16$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/util/List;)V
    .locals 0
...
.method final synthetic lambda$getOrCreateUserReleaseFuture$6$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method final synthetic lambda$isMeteringRepeatingAttached$13$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 2
...
.method final synthetic lambda$isMeteringRepeatingAttached$14$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method final synthetic lambda$isUseCaseAttached$11$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;Ljava/lang/String;)V
    .locals 1
...
.method final synthetic lambda$isUseCaseAttached$12$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/lang/String;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method final synthetic lambda$onUseCaseActive$7$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/lang/String;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/UseCaseConfig;Landroidx/camera/core/impl/StreamSpec;Ljava/util/List;)V
    .locals 8
...
.method final synthetic lambda$onUseCaseInactive$8$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/lang/String;)V
    .locals 2
...
.method final synthetic lambda$onUseCaseUpdated$9$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/lang/String;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/UseCaseConfig;Landroidx/camera/core/impl/StreamSpec;Ljava/util/List;)V
    .locals 7
...
.method final synthetic lambda$openCameraConfigAndClose$1$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method final synthetic lambda$release$4$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 1
...
.method final synthetic lambda$release$5$androidx-camera-camera2-internal-Camera2CameraImpl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method final synthetic lambda$resetUseCase$10$androidx-camera-camera2-internal-Camera2CameraImpl(Ljava/lang/String;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/UseCaseConfig;Landroidx/camera/core/impl/StreamSpec;Ljava/util/List;)V
    .locals 7
...
.method final synthetic lambda$setActiveResumingMode$18$androidx-camera-camera2-internal-Camera2CameraImpl(Z)V
    .locals 1
...
.method final openCaptureSession()V
    .locals 5
...
.method final postSurfaceClosedError(Landroidx/camera/core/impl/SessionConfig;)V
    .locals 4
...
.method final releaseSession(Landroidx/camera/camera2/internal/CaptureSessionInterface;Z)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method final resetCaptureSession(Z)V
    .locals 5
...
.method final setState(Landroidx/camera/camera2/internal/Camera2CameraImpl$InternalState;)V
    .locals 1
...
.method final setState(Landroidx/camera/camera2/internal/Camera2CameraImpl$InternalState;Landroidx/camera/core/CameraState$StateError;)V
    .locals 1
...
.method final setState(Landroidx/camera/camera2/internal/Camera2CameraImpl$InternalState;Landroidx/camera/core/CameraState$StateError;Z)V
    .locals 2
...
.method final submitCaptureRequests(Ljava/util/List;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method final traceInternalState(Landroidx/camera/camera2/internal/Camera2CameraImpl$InternalState;Landroidx/camera/core/CameraState$StateError;)V
    .locals 2
...
.method final tryForceOpenCameraDevice(Z)V
    .locals 1
...
.method final tryOpenCameraDevice(Z)V
    .locals 1
...
.method final updateCaptureSessionConfig()V
    .locals 3
