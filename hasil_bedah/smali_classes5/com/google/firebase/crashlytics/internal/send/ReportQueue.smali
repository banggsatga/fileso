...
.field private final transport:LImageAnalysisExternalSyntheticLambda4;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(DDJLImageAnalysisExternalSyntheticLambda4;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(DDJ",
    ...
    .line 79
    iput-object p7, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LImageAnalysisExternalSyntheticLambda4;
...
.method constructor <init>(LImageAnalysisExternalSyntheticLambda4;Lcom/google/firebase/crashlytics/internal/settings/Settings;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;-><init>(DDJLImageAnalysisExternalSyntheticLambda4;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
...
.method private sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    .line 154
    :goto_0
    iget-object v1, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LImageAnalysisExternalSyntheticLambda4;
    ...
    .line 1134
    new-instance v3, LsetSensorToBufferTransformMatrix;

    sget-object v4, Lcom/google/android/datatransport/Priority;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:Lcom/google/android/datatransport/Priority;

    const/4 v5, 0x0

    invoke-direct {v3, v2, v4, v5}, LsetSensorToBufferTransformMatrix;-><init>(Ljava/lang/Object;Lcom/google/android/datatransport/Priority;LImageAnalysisExternalSyntheticLambda2;)V
    ...
    .line 154
    invoke-interface {v1, v3, v2}, LImageAnalysisExternalSyntheticLambda4;->TuitionPaymentFragmentspecialinlinedviewModeldefault2(LImageAnalysisExternalSyntheticLambda3;LgetDefaultTargetResolution;)V
...
# virtual methods
.method final enqueueReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Z)Lcom/google/android/gms/tasks/TaskCompletionSource;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final flushScheduledReportsIfAble()V
    .locals 4
...
.method final synthetic lambda$flushScheduledReportsIfAble$0$com-google-firebase-crashlytics-internal-send-ReportQueue(Ljava/util/concurrent/CountDownLatch;)V
    .locals 5

    .line 137
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LImageAnalysisExternalSyntheticLambda4;
    ...
    .line 2033
    instance-of v2, v0, Lattach;

    if-eqz v2, :cond_1

    .line 2034
    check-cast v0, Lattach;

    .line 3062
    iget-object v0, v0, Lattach;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:Ldetach;
    ...
    .line 4079
    invoke-virtual {v0}, Ldetach;->TuitionPaymentFragmentspecialinlinedviewModeldefault3()Ljava/lang/String;
    ...
    .line 4080
    invoke-virtual {v2, v1}, Ldetach$TuitionPaymentFragmentspecialinlinedviewModeldefault2;->TuitionPaymentFragmentspecialinlinedviewModeldefault3(Lcom/google/android/datatransport/Priority;)Ldetach$TuitionPaymentFragmentspecialinlinedviewModeldefault2;

    move-result-object v1

    .line 4081
    invoke-virtual {v0}, Ldetach;->TuitionPaymentFragmentbindingInflater1()[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ldetach$TuitionPaymentFragmentspecialinlinedviewModeldefault2;->TuitionPaymentFragmentbindingInflater1([B)Ldetach$TuitionPaymentFragmentspecialinlinedviewModeldefault2;
    ...
    .line 2035
    invoke-virtual {v1, v0, v2}, LgetOutputFormat;->TuitionPaymentFragmentspecialinlinedviewModeldefault3(Ldetach;I)Lcom/google/android/datatransport/runtime/backends/BackendResponse;
    ...
    :try_start_1
    invoke-static {v4, v1}, LgetJpegQualityInternal;->TuitionPaymentFragmentbindingInflater1(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method final synthetic lambda$sendReport$1$com-google-firebase-crashlytics-internal-send-ReportQueue(Lcom/google/android/gms/tasks/TaskCompletionSource;ZLcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Ljava/lang/Exception;)V
    .locals 0
