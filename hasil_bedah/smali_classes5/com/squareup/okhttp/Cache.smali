...
.method static synthetic access$1000(LpropagateChildrenTemplate;)I
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 131
    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(LpropagateChildrenTemplate;)I
...
.method private static readInt(LpropagateChildrenTemplate;)I
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 681
    :try_start_0
    invoke-interface {p0}, LpropagateChildrenTemplate;->INotificationSideChannel()J

    move-result-wide v0

    .line 682
    invoke-interface {p0}, LpropagateChildrenTemplate;->readTypedObject()Ljava/lang/String;
...
.method private trackResponse(Lcom/squareup/okhttp/internal/http/CacheStrategy;)V
    .locals 1
...
.method final get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v0, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)LnotifyStateAttached;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(LnotifyStateAttached;)V
    :try_end_1
...
.method public final getWriteAbortCount()I
    .locals 1
...
.method public final getWriteSuccessCount()I
    .locals 1
