...
.method private shouldCrop(II)Z
    ...
    .line 189
    iget p2, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mMaxResultImageSizeX:I

    const/4 v0, 0x1

    if-lez p2, :cond_0

    iget p2, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mMaxResultImageSizeY:I

    if-gtz p2, :cond_2

    :cond_0
    iget-object p2, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mCropRect:Landroid/graphics/RectF;
