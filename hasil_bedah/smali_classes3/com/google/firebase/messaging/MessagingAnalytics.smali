...
.method public static logNotificationReceived(Landroid/content/Intent;)V
    ...
    .line 87
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()LupdateTransform;

    move-result-object v1

    .line 84
    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/MessagingAnalytics;->logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;LupdateTransform;)V

    :cond_1
    return-void
.end method

.method private static logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;LupdateTransform;)V
    .locals 4
    ...
    .line 1026
    new-instance v0, LsetTargetRotation;

    invoke-direct {v0, p1}, LsetTargetRotation;-><init>(Ljava/lang/Integer;)V

    .line 350
    const-string p1, "proto"

    .line 2030
    new-instance v1, LsetAnalyzer;

    invoke-direct {v1, p1}, LsetAnalyzer;-><init>(Ljava/lang/String;)V
    ...
    invoke-interface {p2, v2, v3, v1, p1}, LupdateTransform;->b(Ljava/lang/String;Ljava/lang/Class;LsetAnalyzer;Lanalyze;)LImageAnalysisExternalSyntheticLambda4;
    ...
    .line 3058
    new-instance p2, LsetSensorToBufferTransformMatrix;
    ...
    invoke-direct {p2, p0, v1, v0}, LsetSensorToBufferTransformMatrix;-><init>(Ljava/lang/Object;Lcom/google/android/datatransport/Priority;LImageAnalysisExternalSyntheticLambda2;)V

    .line 352
    invoke-interface {p1, p2}, LImageAnalysisExternalSyntheticLambda4;->TuitionPaymentFragmentspecialinlinedviewModeldefault3(LImageAnalysisExternalSyntheticLambda3;)V
    :try_end_0
