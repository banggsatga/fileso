...
.method private static fromJchInViewingConditions(DDDLcom/google/android/material/color/utilities/ViewingConditions;)Lcom/google/android/material/color/utilities/Cam16;
    ...
    const-wide v27, 0x3f7cac083126e979L    # 0.007

    mul-double v27, v27, p0
    ...
    const-wide v27, 0x3f9758e219652bd4L    # 0.0228

    mul-double v21, v21, v27

    .line 327
    invoke-static/range {v21 .. v22}, Ljava/lang/Math;->log1p(D)D

    move-result-wide v21

    const-wide v27, 0x4045ee08fb823ee0L    # 43.859649122807014
    ...
    .line 330
    new-instance v29, Lcom/google/android/material/color/utilities/Cam16;
    ...
    mul-double v15, v27, v21

    mul-double v17, v25, v21
...
.method static fromXyzInViewingConditions(DDDLcom/google/android/material/color/utilities/ViewingConditions;)Lcom/google/android/material/color/utilities/Cam16;
    ...
    const-wide v32, 0x40ae0c4ec4ec4ec5L    # 3846.153846153846
    ...
    const-wide v8, 0x3ffb333333333334L    # 1.7000000000000002

    mul-double v8, v8, v24

    const-wide v10, 0x3f7cac083126e979L    # 0.007
    ...
    const-wide v8, 0x4045ee08fb823ee0L    # 43.859649122807014
    ...
    .line 294
    new-instance v10, Lcom/google/android/material/color/utilities/Cam16;
    ...
    mul-double v26, v0, v30

    const-wide/high16 v0, 0x4049000000000000L    # 50.0

    mul-double v30, v4, v0

    mul-double v34, v6, v8

    mul-double v36, v6, v2
...
# virtual methods
.method final distance(Lcom/google/android/material/color/utilities/Cam16;)D
    .locals 8
...
.method public final getAstar()D
    .locals 2
...
.method public final getBstar()D
    .locals 2
...
.method public final getJstar()D
    .locals 2
...
.method final viewed(Lcom/google/android/material/color/utilities/ViewingConditions;)I
    .locals 7
...
.method final xyzInViewingConditions(Lcom/google/android/material/color/utilities/ViewingConditions;[D)[D
    .locals 26
    ...
    const-wide v18, 0x3fd3851eb851eb85L    # 0.305
    ...
    const-wide v14, 0x4070500000000000L    # 261.0
