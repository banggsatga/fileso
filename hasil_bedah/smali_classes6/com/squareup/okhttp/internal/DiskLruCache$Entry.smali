...
.method final snapshot()Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    new-array v0, v0, [LnotifyStateAttached;
    ...
    invoke-interface {v2, v3}, Lcom/squareup/okhttp/internal/io/FileSystem;->source(Ljava/io/File;)LnotifyStateAttached;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;Ljava/lang/String;J[LnotifyStateAttached;[JLcom/squareup/okhttp/internal/DiskLruCache$1;)V
    :try_end_0
...
.method final writeLengths(LgetSharingNode;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 981
    invoke-interface {p1, v5}, LgetSharingNode;->TuitionPaymentFragmentspecialinlinedviewModeldefault1(I)LgetSharingNode;

    move-result-object v5

    invoke-interface {v5, v3, v4}, LgetSharingNode;->a(J)LgetSharingNode;
