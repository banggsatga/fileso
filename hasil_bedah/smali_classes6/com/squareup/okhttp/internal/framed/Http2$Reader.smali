...
# direct methods
.method constructor <init>(LpropagateChildrenTemplate;IZ)V
    .locals 0
    ...
    .line 96
    iput-object p1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;
    ...
    invoke-direct {p3, p1}, Lcom/squareup/okhttp/internal/framed/Http2$ContinuationSource;-><init>(LpropagateChildrenTemplate;)V
    ...
    invoke-direct {p1, p2, p3}, Lcom/squareup/okhttp/internal/framed/Hpack$Reader;-><init>(ILnotifyStateAttached;)V
...
.method private readData(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 225
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;
    ...
    .line 228
    iget-object p3, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;

    invoke-interface {p1, v0, p4, p3, p2}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->data(ZILpropagateChildrenTemplate;I)V

    .line 229
    iget-object p1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;
...
.method private readGoAway(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    invoke-interface {p3}, LpropagateChildrenTemplate;->INotificationSideChannelStub()I

    move-result p3

    .line 337
    iget-object p4, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;

    invoke-interface {p4}, LpropagateChildrenTemplate;->INotificationSideChannelStub()I
    ...
    .line 339
    invoke-static {p4}, Lcom/squareup/okhttp/internal/framed/ErrorCode;->fromHttp2(I)Lcom/squareup/okhttp/internal/framed/ErrorCode;
    ...
    invoke-interface {p4, v1, v2}, LpropagateChildrenTemplate;->TuitionPaymentFragmentspecialinlinedviewModeldefault2(J)Lokio/ByteString;

    move-result-object p4

    .line 347
    :cond_0
    invoke-interface {p1, p3, v0, p4}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->goAway(ILcom/squareup/okhttp/internal/framed/ErrorCode;Lokio/ByteString;)V
...
.method private readHeaders(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 189
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;
...
.method private readPriority(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;I)V
    ...
    .line 243
    :goto_0
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;
...
.method private readPushPromise(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    invoke-interface {v1}, LpropagateChildrenTemplate;->INotificationSideChannelStub()I
    ...
    .line 319
    invoke-interface {p1, p4, p3, p2}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->pushPromise(IILjava/util/List;)V
...
.method private readRstStream(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 251
    iget-object p2, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;

    invoke-interface {p2}, LpropagateChildrenTemplate;->INotificationSideChannelStub()I
...
.method private readSettings(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 271
    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:LpropagateChildrenTemplate;

    invoke-interface {v2}, LpropagateChildrenTemplate;->access100()S
...
.method public final nextFrame(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;)Z
    ...
    invoke-static {v0}, Lcom/squareup/okhttp/internal/framed/Http2;->access$300(LpropagateChildrenTemplate;)I
...
.method public final readConnectionPreface()V
    ...
    invoke-virtual {v0}, Lokio/ByteString;->TuitionPaymentFragmentspecialinlinedviewModeldefault1()Ljava/lang/String;
