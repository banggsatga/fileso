...
.method private findConnection(IIIZ)Lcom/squareup/okhttp/internal/io/RealConnection;
    ...
    invoke-virtual {v1, v2, v7}, Lcom/squareup/okhttp/internal/Internal;->put(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/internal/io/RealConnection;)V
...
.method public final connection()Lcom/squareup/okhttp/internal/io/RealConnection;
    .locals 1
...
.method public final newStream(IIIZZ)Lcom/squareup/okhttp/internal/http/HttpStream;
    ...
    .line 103
    iget-object p4, p1, Lcom/squareup/okhttp/internal/io/RealConnection;->source:LpropagateChildrenTemplate;

    invoke-interface {p4}, LpropagateChildrenTemplate;->timeout()LnotifyStateDetached;
    ...
    invoke-virtual {p4, v0, v1, p2}, LnotifyStateDetached;->timeout(JLjava/util/concurrent/TimeUnit;)LnotifyStateDetached;

    .line 104
    iget-object p2, p1, Lcom/squareup/okhttp/internal/io/RealConnection;->sink:LgetSharingNode;

    invoke-interface {p2}, LgetSharingNode;->timeout()LnotifyStateDetached;
    ...
    invoke-virtual {p2, p3, p4, p5}, LnotifyStateDetached;->timeout(JLjava/util/concurrent/TimeUnit;)LnotifyStateDetached;

    .line 105
    new-instance p2, Lcom/squareup/okhttp/internal/http/Http1xStream;

    iget-object p3, p1, Lcom/squareup/okhttp/internal/io/RealConnection;->source:LpropagateChildrenTemplate;

    iget-object p4, p1, Lcom/squareup/okhttp/internal/io/RealConnection;->sink:LgetSharingNode;

    invoke-direct {p2, p0, p3, p4}, Lcom/squareup/okhttp/internal/http/Http1xStream;-><init>(Lcom/squareup/okhttp/internal/http/StreamAllocation;LpropagateChildrenTemplate;LgetSharingNode;)V
...
.method public final recover(Ljava/io/IOException;LtoChildrenConfigsMap;)Z
    .locals 3
