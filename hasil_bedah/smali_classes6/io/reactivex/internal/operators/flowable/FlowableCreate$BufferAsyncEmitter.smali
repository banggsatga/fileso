...
# direct methods
.method constructor <init>(LshutdownAsync;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 455
    invoke-direct {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BaseEmitter;-><init>(LshutdownAsync;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->queue:LisCancelled;
...
.method private g()V
    ...
    .line 515
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->queue:LisCancelled;
    ...
    .line 536
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->TuitionPaymentFragmentspecialinlinedviewModeldefault2(Ljava/lang/Throwable;)Z

    return-void

    .line 538
    :cond_4
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->TuitionPaymentFragmentbindingInflater1()V
    ...
    .line 547
    invoke-interface {v0, v12}, LshutdownAsync;->onNext(Ljava/lang/Object;)V
    ...
    .line 574
    invoke-static {p0, v8, v9}, LSequentialExecutor1;->TuitionPaymentFragmentspecialinlinedviewModeldefault1(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public final TuitionPaymentFragmentbindingInflater1(Ljava/lang/Object;)V
    ...
    .line 470
    :cond_1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->queue:LisCancelled;

    invoke-virtual {v0, p1}, LisCancelled;->a_(Ljava/lang/Object;)Z

    .line 471
    invoke-direct {p0}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;->g()V
