...
.field final synthetic $resultChannel:LgetSizeListByFormat;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>([LcorrectStartOrEnd;ILjava/util/concurrent/atomic/AtomicInteger;LgetSizeListByFormat;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 65354
    iput-object p1, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$flows:[LcorrectStartOrEnd;
    ...
    iput-object p4, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$resultChannel:LgetSizeListByFormat;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$flows:[LcorrectStartOrEnd;
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$resultChannel:LgetSizeListByFormat;

    move-object v0, p1

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;-><init>([LcorrectStartOrEnd;ILjava/util/concurrent/atomic/AtomicInteger;LgetSizeListByFormat;Lkotlin/coroutines/Continuation;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 28
    :try_start_1
    iget-object p1, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$flows:[LcorrectStartOrEnd;
    ...
    invoke-direct {v1, v4, v5}, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1$1;-><init>(LgetSizeListByFormat;I)V
    ...
    invoke-interface {p1, v1, v4}, LcorrectStartOrEnd;->collect(LgetScaledRect;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 35
    iget-object p1, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$resultChannel:LgetSizeListByFormat;

    check-cast p1, LisRotationNeeded;

    .line 2095
    invoke-interface {p1, v2}, LisRotationNeeded;->TuitionPaymentFragmentspecialinlinedviewModeldefault3(Ljava/lang/Throwable;)Z
    ...
    .line 35
    iget-object v0, p0, Lkotlinx/coroutines/flow/internal/CombineKt$combineInternal$2$1;->$resultChannel:LgetSizeListByFormat;

    check-cast v0, LisRotationNeeded;

    .line 3095
    invoke-interface {v0, v2}, LisRotationNeeded;->TuitionPaymentFragmentspecialinlinedviewModeldefault3(Ljava/lang/Throwable;)Z
