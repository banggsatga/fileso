...
.method static constructor <clinit>()V
    ...
    .line 16
    sput-object v1, LG;->b:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/news/remote/NewsApiClient;
    .locals 3
    ...
    .line 4018
    const-class v0, Lcom/bpjstku/data/news/remote/NewsApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/news/remote/NewsApiClient;

    return-object p0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LComponentActivityReportFullyDrawnExecutorImplExternalSyntheticLambda0;
    .locals 1
    ...
    .line 1043
    const-class p1, Lcom/bpjstku/data/news/NewsRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/news/NewsRepository;

    .line 1024
    new-instance p1, LgetOnDrawScheduled;

    invoke-direct {p1, p0}, LgetOnDrawScheduled;-><init>(Lcom/bpjstku/data/news/NewsRepository;)V

    check-cast p1, LComponentActivityReportFullyDrawnExecutorImplExternalSyntheticLambda0;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LG;->b:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/news/remote/NewsApi;
    .locals 1
    ...
    .line 2035
    const-class p1, Lcom/bpjstku/data/news/remote/NewsApiClient;
    ...
    .line 2020
    new-instance p1, Lcom/bpjstku/data/news/remote/NewsApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/news/remote/NewsApi;-><init>(Lcom/bpjstku/data/news/remote/NewsApiClient;)V

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LTintInfo;
    .locals 2
    ...
    .line 25047
    const-class p1, LComponentActivityReportFullyDrawnExecutorImplExternalSyntheticLambda0;
    ...
    .line 25026
    new-instance v0, LTintInfo;

    invoke-direct {v0, p1, p0}, LTintInfo;-><init>(LComponentActivityReportFullyDrawnExecutorImplExternalSyntheticLambda0;LgetLastModifiedTimestamp;)V

    return-object v0
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/news/NewsRepository;
    .locals 1
    ...
    .line 3039
    const-class p1, Lcom/bpjstku/data/news/remote/NewsApi;
    ...
    check-cast p0, Lcom/bpjstku/data/news/remote/NewsApi;

    .line 3022
    new-instance p1, Lcom/bpjstku/data/news/NewsDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/news/NewsDataStore;-><init>(Lcom/bpjstku/data/news/remote/NewsApi;)V

    check-cast p1, Lcom/bpjstku/data/news/NewsRepository;
...
.method public static synthetic b(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LonActivityPaused;

    invoke-direct {v0}, LonActivityPaused;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/news/remote/NewsApiClient;
    ...
    .line 6063
    new-instance v0, LonActivityStopped;

    invoke-direct {v0}, LonActivityStopped;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/news/remote/NewsApi;
    ...
    .line 6079
    new-instance v0, LonActivityStarted;

    invoke-direct {v0}, LonActivityStarted;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/news/NewsRepository;
    ...
    .line 6095
    new-instance v0, LonActivityResumed;

    invoke-direct {v0}, LonActivityResumed;-><init>()V
    ...
    const-class v5, LComponentActivityReportFullyDrawnExecutorImplExternalSyntheticLambda0;
    ...
    .line 6026
    new-instance v0, LonActivitySaveInstanceState;

    invoke-direct {v0}, LonActivitySaveInstanceState;-><init>()V
