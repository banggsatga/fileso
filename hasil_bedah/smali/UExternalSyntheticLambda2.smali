.class public final LUExternalSyntheticLambda2;
...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LVExternalSyntheticLambda1;

    invoke-direct {v0}, LVExternalSyntheticLambda1;-><init>()V
    ...
    .line 16
    sput-object v1, LUExternalSyntheticLambda2;->TuitionPaymentFragmentspecialinlinedviewModeldefault1:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/promo/remote/PromoApiClient;
    .locals 3
    ...
    .line 24018
    const-class v0, Lcom/bpjstku/data/promo/remote/PromoApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/promo/remote/PromoApiClient;

    return-object p0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LOnBackPressedDispatcher5;
    .locals 1
    ...
    .line 21052
    const-class p1, Lcom/bpjstku/data/promo/PromoRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/promo/PromoRepository;

    .line 21029
    new-instance p1, LaccessupdateEnabledCallbacks;

    invoke-direct {p1, p0}, LaccessupdateEnabledCallbacks;-><init>(Lcom/bpjstku/data/promo/PromoRepository;)V

    check-cast p1, LOnBackPressedDispatcher5;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LUExternalSyntheticLambda2;->TuitionPaymentFragmentspecialinlinedviewModeldefault1:LaccessisVideoCapture;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LVExternalSyntheticLambda5;

    invoke-direct {v0}, LVExternalSyntheticLambda5;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/promo/remote/PromoApiClient;
    ...
    .line 1072
    new-instance v0, LVExternalSyntheticLambda2;

    invoke-direct {v0}, LVExternalSyntheticLambda2;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/promo/remote/PromoApi;
    ...
    .line 1088
    new-instance v0, LVExternalSyntheticLambda4;

    invoke-direct {v0}, LVExternalSyntheticLambda4;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/promo/PromoRepository;
    ...
    .line 1104
    new-instance v0, LVExternalSyntheticLambda3;

    invoke-direct {v0}, LVExternalSyntheticLambda3;-><init>()V
    ...
    const-class v5, LOnBackPressedDispatcher5;
    ...
    .line 1031
    new-instance v0, LVExternalSyntheticLambda6;

    invoke-direct {v0}, LVExternalSyntheticLambda6;-><init>()V
    ...
    const-class v5, LsetZslDisabledByUserCaseConfig;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LsetZslDisabledByUserCaseConfig;
    .locals 4
    ...
    .line 23056
    const-class p1, LOnBackPressedDispatcher5;
    ...
    .line 23031
    new-instance v0, LsetZslDisabledByUserCaseConfig;

    invoke-direct {v0, p1, v1, v2, p0}, LsetZslDisabledByUserCaseConfig;-><init>(LOnBackPressedDispatcher5;LOutputSurface;LisCustomAccentColorApplied;LgetLastModifiedTimestamp;)V

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/promo/PromoRepository;
    .locals 2
    ...
    .line 22048
    const-class p1, Lcom/bpjstku/data/promo/remote/PromoApi;
    ...
    check-cast p1, Lcom/bpjstku/data/promo/remote/PromoApi;
    ...
    .line 22027
    new-instance v0, Lcom/bpjstku/data/promo/PromoDataStore;

    invoke-direct {v0, p1, p0}, Lcom/bpjstku/data/promo/PromoDataStore;-><init>(Lcom/bpjstku/data/promo/remote/PromoApi;LOutputSurface;)V

    check-cast v0, Lcom/bpjstku/data/promo/PromoRepository;

    return-object v0
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/promo/remote/PromoApi;
    .locals 1
    ...
    .line 20044
    const-class p1, Lcom/bpjstku/data/promo/remote/PromoApiClient;
    ...
    .line 20025
    new-instance p1, Lcom/bpjstku/data/promo/remote/PromoApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/promo/remote/PromoApi;-><init>(Lcom/bpjstku/data/promo/remote/PromoApiClient;)V
