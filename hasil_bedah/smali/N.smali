...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LOExternalSyntheticLambda0;

    invoke-direct {v0}, LOExternalSyntheticLambda0;-><init>()V
    ...
    .line 16
    sput-object v1, LN;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;
    .locals 3
    ...
    .line 1018
    const-class v0, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;

    return-object p0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LComponentDialog;
    .locals 1
    ...
    .line 23043
    const-class p1, Lcom/bpjstku/data/otpverification/OtpVerificationRepository;
    ...
    .line 23024
    new-instance p1, LComponentActivityactivityResultRegistry1ExternalSyntheticLambda1;

    invoke-direct {p1, p0}, LComponentActivityactivityResultRegistry1ExternalSyntheticLambda1;-><init>(Lcom/bpjstku/data/otpverification/OtpVerificationRepository;)V

    check-cast p1, LComponentDialog;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LN;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetNavigationContentDescription;
    .locals 2
    ...
    .line 25047
    const-class p1, LComponentDialog;
    ...
    .line 25026
    new-instance v0, LgetNavigationContentDescription;

    invoke-direct {v0, p1, p0}, LgetNavigationContentDescription;-><init>(LComponentDialog;LgetLastModifiedTimestamp;)V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LMExternalSyntheticLambda3;

    invoke-direct {v0}, LMExternalSyntheticLambda3;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;
    ...
    const-class v5, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;
    ...
    .line 3079
    new-instance v0, LMExternalSyntheticLambda2;

    invoke-direct {v0}, LMExternalSyntheticLambda2;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/otpverification/OtpVerificationRepository;
    ...
    .line 3095
    new-instance v0, LMExternalSyntheticLambda1;

    invoke-direct {v0}, LMExternalSyntheticLambda1;-><init>()V
    ...
    const-class v5, LComponentDialog;
    ...
    .line 3026
    new-instance v0, Lr8lambdalHmNJSrHqzvR3lGLIEmplJlVZCs;

    invoke-direct {v0}, Lr8lambdalHmNJSrHqzvR3lGLIEmplJlVZCs;-><init>()V
    ...
    const-class v5, LgetNavigationContentDescription;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;
    .locals 1
    ...
    .line 24035
    const-class p1, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;
    ...
    .line 24020
    new-instance p1, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;-><init>(Lcom/bpjstku/data/otpverification/remote/OtpVerificationApiClient;)V

    return-object p1
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/otpverification/OtpVerificationRepository;
    .locals 1
    ...
    .line 22039
    const-class p1, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;
    ...
    check-cast p0, Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;

    .line 22022
    new-instance p1, Lcom/bpjstku/data/otpverification/OtpVerificationDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/otpverification/OtpVerificationDataStore;-><init>(Lcom/bpjstku/data/otpverification/remote/OtpVerificationApi;)V

    check-cast p1, Lcom/bpjstku/data/otpverification/OtpVerificationRepository;
