.class public final LgetLocalizedAlertText;
...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LgetMalwareName;

    invoke-direct {v0}, LgetMalwareName;-><init>()V
    ...
    .line 16
    sput-object v1, LgetLocalizedAlertText;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LCamera2CapturePipelineTorchTask;
    .locals 2
    ...
    .line 6048
    const-class p1, LgetCallerContract;
    ...
    check-cast p1, LgetCallerContract;
    ...
    .line 6026
    new-instance v0, LCamera2CapturePipelineTorchTask;

    invoke-direct {v0, p1, p0}, LCamera2CapturePipelineTorchTask;-><init>(LgetCallerContract;LgetLastModifiedTimestamp;)V

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/syariah/SyariahRepository;
    .locals 1
    ...
    .line 5040
    const-class p1, Lcom/bpjstku/data/syariah/remote/SyariahApi;
    ...
    check-cast p0, Lcom/bpjstku/data/syariah/remote/SyariahApi;

    .line 5022
    new-instance p1, Lcom/bpjstku/data/syariah/SyariahDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/syariah/SyariahDataStore;-><init>(Lcom/bpjstku/data/syariah/remote/SyariahApi;)V

    check-cast p1, Lcom/bpjstku/data/syariah/SyariahRepository;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LgetLocalizedAlertButtonText;

    invoke-direct {v0}, LgetLocalizedAlertButtonText;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/syariah/remote/SyariahApiClient;
    ...
    .line 7064
    new-instance v0, LgetLocalizedName;

    invoke-direct {v0}, LgetLocalizedName;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/syariah/remote/SyariahApi;
    ...
    .line 7080
    new-instance v0, LgetMalwareFamily;

    invoke-direct {v0}, LgetMalwareFamily;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/syariah/SyariahRepository;
    ...
    .line 7096
    new-instance v0, LgetLocalizedResolution;

    invoke-direct {v0}, LgetLocalizedResolution;-><init>()V
    ...
    const-class v5, LgetCallerContract;
    ...
    .line 7026
    new-instance v0, LgetProfileName;

    invoke-direct {v0}, LgetProfileName;-><init>()V
    ...
    const-class v5, LCamera2CapturePipelineTorchTask;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LgetLocalizedAlertText;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/syariah/remote/SyariahApi;
    .locals 1
    ...
    .line 4036
    const-class p1, Lcom/bpjstku/data/syariah/remote/SyariahApiClient;
    ...
    check-cast p0, Lcom/bpjstku/data/syariah/remote/SyariahApiClient;

    .line 4020
    new-instance p1, Lcom/bpjstku/data/syariah/remote/SyariahApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/syariah/remote/SyariahApi;-><init>(Lcom/bpjstku/data/syariah/remote/SyariahApiClient;)V

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/syariah/remote/SyariahApiClient;
    .locals 3
    ...
    .line 1018
    const-class v0, Lcom/bpjstku/data/syariah/remote/SyariahApiClient;
...
.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetCallerContract;
    .locals 2
    ...
    .line 3044
    const-class p1, Lcom/bpjstku/data/syariah/SyariahRepository;
    ...
    .line 3024
    new-instance v0, Lr8lambdap6fMCAr3kK9mRhAhUUFoxiKf_xU;

    invoke-direct {v0, p1, p0}, Lr8lambdap6fMCAr3kK9mRhAhUUFoxiKf_xU;-><init>(Lcom/bpjstku/data/syariah/SyariahRepository;LOutputSurface;)V

    check-cast v0, LgetCallerContract;
