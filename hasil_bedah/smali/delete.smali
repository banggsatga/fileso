...
.method static constructor <clinit>()V
    ...
    .line 23
    new-instance v0, LFastestIyyExternalSyntheticLambda2;

    invoke-direct {v0}, LFastestIyyExternalSyntheticLambda2;-><init>()V
    ...
    .line 23
    sput-object v1, Ldelete;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LComponentActivity4;
    .locals 2
    ...
    .line 4050
    const-class p1, Lcom/bpjstku/data/menu/MenuRepository;
    ...
    check-cast p1, Lcom/bpjstku/data/menu/MenuRepository;
    ...
    .line 4031
    new-instance v0, LComponentActivityExternalSyntheticLambda2;

    invoke-direct {v0, p1, p0}, LComponentActivityExternalSyntheticLambda2;-><init>(Lcom/bpjstku/data/menu/MenuRepository;LOutputSurface;)V

    check-cast v0, LComponentActivity4;
...
.method public static synthetic TuitionPaymentFragmentbindingInflater1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, Ldoubt_villa;

    invoke-direct {v0}, Ldoubt_villa;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/menu/remote/MenuApiClient;
    ...
    .line 5070
    new-instance v0, Lclubs_neighborhood;

    invoke-direct {v0}, Lclubs_neighborhood;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/menu/remote/MenuApi;
    ...
    .line 5086
    new-instance v0, Lweight_success;

    invoke-direct {v0}, Lweight_success;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/menu/MenuRepository;
    ...
    .line 5102
    new-instance v0, Lspecify_simon;

    invoke-direct {v0}, Lspecify_simon;-><init>()V
    ...
    const-class v5, LComponentActivity4;
    ...
    .line 5033
    new-instance v0, LonCreate;

    invoke-direct {v0}, LonCreate;-><init>()V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/menu/MenuRepository;
    .locals 1
    ...
    .line 2046
    const-class p1, Lcom/bpjstku/data/menu/remote/MenuApi;
    ...
    check-cast p0, Lcom/bpjstku/data/menu/remote/MenuApi;

    .line 2029
    new-instance p1, Lcom/bpjstku/data/menu/MenuDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/menu/MenuDataStore;-><init>(Lcom/bpjstku/data/menu/remote/MenuApi;)V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LMenuPopup;
    .locals 3
    ...
    .line 3054
    const-class p1, LComponentActivity4;
    ...
    check-cast p1, LComponentActivity4;
    ...
    .line 3033
    new-instance v0, LMenuPopup;

    invoke-direct {v0, p1, v1, p0}, LMenuPopup;-><init>(LComponentActivity4;LOutputSurface;LgetLastModifiedTimestamp;)V
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 23
    sget-object v0, Ldelete;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/menu/remote/MenuApiClient;
    .locals 3
    ...
    .line 24025
    const-class v0, Lcom/bpjstku/data/menu/remote/MenuApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/menu/remote/MenuApiClient;

    return-object p0
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/menu/remote/MenuApi;
    .locals 1
    ...
    .line 1042
    const-class p1, Lcom/bpjstku/data/menu/remote/MenuApiClient;
    ...
    .line 1027
    new-instance p1, Lcom/bpjstku/data/menu/remote/MenuApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/menu/remote/MenuApi;-><init>(Lcom/bpjstku/data/menu/remote/MenuApiClient;)V
