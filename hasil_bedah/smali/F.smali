...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LonActivityDestroyed;

    invoke-direct {v0}, LonActivityDestroyed;-><init>()V
    ...
    .line 16
    sput-object v1, LF;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;
...
.method public static final TuitionPaymentFragmentbindingInflater1()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LF;->TuitionPaymentFragmentbindingInflater1:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;
    .locals 3
    ...
    .line 1018
    const-class v0, Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;
...
.method public static synthetic TuitionPaymentFragmentbindingInflater1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LEExternalSyntheticLambda2;

    invoke-direct {v0}, LEExternalSyntheticLambda2;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;
    ...
    .line 3063
    new-instance v0, LEExternalSyntheticLambda1;

    invoke-direct {v0}, LEExternalSyntheticLambda1;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;
    ...
    .line 3079
    new-instance v0, LonAccuracyChanged;

    invoke-direct {v0}, LonAccuracyChanged;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/multibiller/MultiBillerRepository;
    ...
    const-class v5, LgetEndWatchTimeMillis;
    ...
    .line 3026
    new-instance v0, LonActivityCreated;

    invoke-direct {v0}, LonActivityCreated;-><init>()V
    ...
    const-class v5, LsetThumbPosition;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetEndWatchTimeMillis;
    .locals 1
    ...
    .line 25043
    const-class p1, Lcom/bpjstku/data/multibiller/MultiBillerRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/multibiller/MultiBillerRepository;

    .line 25024
    new-instance p1, LgetCurrentRunnable;

    invoke-direct {p1, p0}, LgetCurrentRunnable;-><init>(Lcom/bpjstku/data/multibiller/MultiBillerRepository;)V

    check-cast p1, LgetEndWatchTimeMillis;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LsetThumbPosition;
    .locals 2
    ...
    .line 23047
    const-class p1, LgetEndWatchTimeMillis;
    ...
    .line 23026
    new-instance v0, LsetThumbPosition;

    invoke-direct {v0, p1, p0}, LsetThumbPosition;-><init>(LgetEndWatchTimeMillis;LgetLastModifiedTimestamp;)V

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/multibiller/MultiBillerRepository;
    .locals 1
    ...
    .line 22039
    const-class p1, Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;
    ...
    check-cast p0, Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;

    .line 22022
    new-instance p1, Lcom/bpjstku/data/multibiller/MultiBillerDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/multibiller/MultiBillerDataStore;-><init>(Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;)V

    check-cast p1, Lcom/bpjstku/data/multibiller/MultiBillerRepository;

    return-object p1
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;
    .locals 1
    ...
    .line 24035
    const-class p1, Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;
    ...
    .line 24020
    new-instance p1, Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/multibiller/remote/MultiBillerApi;-><init>(Lcom/bpjstku/data/multibiller/remote/MultiBillerApiClient;)V
