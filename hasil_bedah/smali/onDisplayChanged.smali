.class public final LonDisplayChanged;
...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LonDisplayRemoved;

    invoke-direct {v0}, LonDisplayRemoved;-><init>()V
    ...
    .line 16
    sput-object v1, LonDisplayChanged;->TuitionPaymentFragmentspecialinlinedviewModeldefault2:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LArchTaskExecutor;
    .locals 2
    ...
    const-class v1, LActivityResultCompanion;
    ...
    check-cast p0, LActivityResultCompanion;

    .line 1026
    new-instance v0, LArchTaskExecutor;

    invoke-direct {v0, p1, p0}, LArchTaskExecutor;-><init>(LgetLastModifiedTimestamp;LActivityResultCompanion;)V

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LActivityResultCompanion;
    .locals 1
    ...
    .line 22043
    const-class p1, Lcom/bpjstku/data/simulation/SimulationRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/simulation/SimulationRepository;

    .line 22024
    new-instance p1, LgetResultCode;

    invoke-direct {p1, p0}, LgetResultCode;-><init>(Lcom/bpjstku/data/simulation/SimulationRepository;)V

    check-cast p1, LActivityResultCompanion;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault2()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LonDisplayChanged;->TuitionPaymentFragmentspecialinlinedviewModeldefault2:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/simulation/remote/SimulationApi;
    .locals 1
    ...
    .line 25035
    const-class p1, Lcom/bpjstku/data/simulation/remote/SimulationApiClient;
    ...
    check-cast p0, Lcom/bpjstku/data/simulation/remote/SimulationApiClient;

    .line 25020
    new-instance p1, Lcom/bpjstku/data/simulation/remote/SimulationApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/simulation/remote/SimulationApi;-><init>(Lcom/bpjstku/data/simulation/remote/SimulationApiClient;)V

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/simulation/remote/SimulationApiClient;
    .locals 3
    ...
    .line 23018
    const-class v0, Lcom/bpjstku/data/simulation/remote/SimulationApiClient;
...
.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/simulation/SimulationRepository;
    .locals 1
    ...
    .line 21039
    const-class p1, Lcom/bpjstku/data/simulation/remote/SimulationApi;
    ...
    check-cast p0, Lcom/bpjstku/data/simulation/remote/SimulationApi;

    .line 21022
    new-instance p1, Lcom/bpjstku/data/simulation/SimulationDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/simulation/SimulationDataStore;-><init>(Lcom/bpjstku/data/simulation/remote/SimulationApi;)V

    check-cast p1, Lcom/bpjstku/data/simulation/SimulationRepository;
...
.method public static synthetic b(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LonAccessibilityStateChanged;

    invoke-direct {v0}, LonAccessibilityStateChanged;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/simulation/remote/SimulationApiClient;
    ...
    .line 2063
    new-instance v0, LgetDownloadDate;

    invoke-direct {v0}, LgetDownloadDate;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/simulation/remote/SimulationApi;
    ...
    .line 2079
    new-instance v0, LgetPolicyType;

    invoke-direct {v0}, LgetPolicyType;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/simulation/SimulationRepository;
    ...
    .line 2095
    new-instance v0, LgetPolicyName;

    invoke-direct {v0}, LgetPolicyName;-><init>()V
    ...
    const-class v5, LActivityResultCompanion;
    ...
    .line 2026
    new-instance v0, LgetPolicyHash;

    invoke-direct {v0}, LgetPolicyHash;-><init>()V
    ...
    const-class v5, LArchTaskExecutor;
