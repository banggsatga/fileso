.class public final LverifySession;
...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LMediaSessionCompatApi21CallbackProxy;

    invoke-direct {v0}, LMediaSessionCompatApi21CallbackProxy;-><init>()V
    ...
    .line 16
    sput-object v1, LverifySession;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/banner/remote/BannerApi;
    .locals 1
    ...
    .line 23035
    const-class p1, Lcom/bpjstku/data/banner/remote/BannerApiClient;
    ...
    check-cast p0, Lcom/bpjstku/data/banner/remote/BannerApiClient;

    .line 23020
    new-instance p1, Lcom/bpjstku/data/banner/remote/BannerApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/banner/remote/BannerApi;-><init>(Lcom/bpjstku/data/banner/remote/BannerApiClient;)V
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault1()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LverifySession;->TuitionPaymentFragmentspecialinlinedviewModeldefault3:LaccessisVideoCapture;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LverifyToken;

    invoke-direct {v0}, LverifyToken;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/banner/remote/BannerApiClient;
    ...
    .line 2063
    new-instance v0, LMediaSessionCompatApi21Callback;

    invoke-direct {v0}, LMediaSessionCompatApi21Callback;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/banner/remote/BannerApi;
    ...
    .line 2079
    new-instance v0, LMediaSessionCompatApi23;

    invoke-direct {v0}, LMediaSessionCompatApi23;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/banner/BannerRepository;
    ...
    .line 2095
    new-instance v0, LMediaSessionCompatApi23Callback;

    invoke-direct {v0}, LMediaSessionCompatApi23Callback;-><init>()V
    ...
    const-class v5, LtExternalSyntheticLambda3;
    ...
    .line 2026
    new-instance v0, LMediaSessionCompatApi22;

    invoke-direct {v0}, LMediaSessionCompatApi22;-><init>()V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LtExternalSyntheticLambda3;
    .locals 1
    ...
    .line 21043
    const-class p1, Lcom/bpjstku/data/banner/BannerRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/banner/BannerRepository;

    .line 21024
    new-instance p1, Lt;

    invoke-direct {p1, p0}, Lt;-><init>(Lcom/bpjstku/data/banner/BannerRepository;)V

    check-cast p1, LtExternalSyntheticLambda3;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/banner/BannerRepository;
    .locals 1
    ...
    .line 1039
    const-class p1, Lcom/bpjstku/data/banner/remote/BannerApi;
    ...
    check-cast p0, Lcom/bpjstku/data/banner/remote/BannerApi;

    .line 1022
    new-instance p1, Lcom/bpjstku/data/banner/BannerDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/banner/BannerDataStore;-><init>(Lcom/bpjstku/data/banner/remote/BannerApi;)V

    check-cast p1, Lcom/bpjstku/data/banner/BannerRepository;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/banner/remote/BannerApiClient;
    .locals 3
    ...
    .line 24018
    const-class v0, Lcom/bpjstku/data/banner/remote/BannerApiClient;
...
.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetInstance;
    .locals 2
    ...
    .line 22047
    const-class p1, LtExternalSyntheticLambda3;
    ...
    .line 22026
    new-instance v0, LgetInstance;

    invoke-direct {v0, p1, p0}, LgetInstance;-><init>(LtExternalSyntheticLambda3;LgetLastModifiedTimestamp;)V
