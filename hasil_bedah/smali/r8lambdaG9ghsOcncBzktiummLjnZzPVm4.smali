.class public final Lr8lambdaG9ghsOcncBzktiummLjnZzPVm4;
...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LOExternalSyntheticLambda3;

    invoke-direct {v0}, LOExternalSyntheticLambda3;-><init>()V
    ...
    .line 16
    sput-object v1, Lr8lambdaG9ghsOcncBzktiummLjnZzPVm4;->b:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LsetDividerPadding;
    .locals 2
    ...
    .line 21027
    new-instance v0, LsetDividerPadding;

    invoke-direct {v0, p1, p0}, LsetDividerPadding;-><init>(Lunregister;LgetLastModifiedTimestamp;)V
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault1()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, Lr8lambdaG9ghsOcncBzktiummLjnZzPVm4;->b:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;
    .locals 3
    ...
    .line 23018
    const-class v0, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;

    return-object p0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;
    .locals 1
    ...
    .line 25040
    const-class p1, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;
    ...
    .line 25020
    new-instance p1, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;-><init>(Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;)V

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lunregister;
    .locals 1
    ...
    .line 20048
    const-class p1, Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;

    .line 20024
    new-instance p1, LgetScrimWithEnforcedContrastactivity_release;

    invoke-direct {p1, p0}, LgetScrimWithEnforcedContrastactivity_release;-><init>(Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;)V
...
.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;
    .locals 1
    ...
    .line 22044
    const-class p1, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;
    ...
    check-cast p0, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;

    .line 22022
    new-instance p1, Lcom/bpjstku/data/registration/pmi/PMIRegistrationDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/registration/pmi/PMIRegistrationDataStore;-><init>(Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;)V

    check-cast p1, Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;
...
.method public static synthetic b(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LonSuccess;

    invoke-direct {v0}, LonSuccess;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApiClient;
    ...
    .line 1072
    new-instance v0, LOExternalSyntheticLambda1;

    invoke-direct {v0}, LOExternalSyntheticLambda1;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/registration/pmi/remote/PMIRegistrationApi;
    ...
    .line 1088
    new-instance v0, LOExternalSyntheticLambda4;

    invoke-direct {v0}, LOExternalSyntheticLambda4;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/registration/pmi/PMIRegistrationRepository;
    ...
    .line 1104
    new-instance v0, LOExternalSyntheticLambda5;

    invoke-direct {v0}, LOExternalSyntheticLambda5;-><init>()V
    ...
    .line 1026
    new-instance v0, LOExternalSyntheticLambda2;

    invoke-direct {v0}, LOExternalSyntheticLambda2;-><init>()V
    ...
    const-class v5, LsetDividerPadding;
