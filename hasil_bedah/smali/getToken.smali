...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LhasCallback;

    invoke-direct {v0}, LhasCallback;-><init>()V
    ...
    .line 16
    sput-object v1, LgetToken;->b:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;
    .locals 1
    ...
    .line 1041
    const-class p1, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;
    ...
    check-cast p0, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;

    .line 1020
    new-instance p1, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;-><init>(Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;)V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LcreateSession;

    invoke-direct {v0}, LcreateSession;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;
    ...
    .line 7077
    new-instance v0, LMediaSessionCompatApi21;

    invoke-direct {v0}, LMediaSessionCompatApi21;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;
    ...
    .line 7093
    new-instance v0, LtoBundle;

    invoke-direct {v0}, LtoBundle;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;
    ...
    .line 7109
    new-instance v0, LMediaSessionCompatToken1;

    invoke-direct {v0}, LMediaSessionCompatToken1;-><init>()V
    ...
    const-class v5, Lr8lambdanoXGr5XZ6ZQiw0NE_bFNhh3sxIQ;
    ...
    .line 7026
    new-instance v0, LMediaSessionCompatApi21QueueItem;

    invoke-direct {v0}, LMediaSessionCompatApi21QueueItem;-><init>()V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lr8lambdanoXGr5XZ6ZQiw0NE_bFNhh3sxIQ;
    .locals 1
    ...
    .line 5049
    const-class p1, Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;

    .line 5024
    new-instance p1, LOnBackPressedDispatcher4;

    invoke-direct {p1, p0}, LOnBackPressedDispatcher4;-><init>(Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;)V

    check-cast p1, Lr8lambdanoXGr5XZ6ZQiw0NE_bFNhh3sxIQ;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;
    .locals 1
    ...
    .line 6045
    const-class p1, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;
    ...
    check-cast p0, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;

    .line 6022
    new-instance p1, Lcom/bpjstku/data/registration/bpu/BPURegistrationDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/registration/bpu/BPURegistrationDataStore;-><init>(Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApi;)V

    check-cast p1, Lcom/bpjstku/data/registration/bpu/BPURegistrationRepository;
...
.method public static final TuitionPaymentFragmentspecialinlinedviewModeldefault3()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LgetToken;->b:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LsetSelector;
    .locals 3
    ...
    .line 2053
    const-class p1, Lr8lambdanoXGr5XZ6ZQiw0NE_bFNhh3sxIQ;
    ...
    .line 2027
    new-instance v0, LsetSelector;

    invoke-direct {v0, p1, v1, p0}, LsetSelector;-><init>(Lr8lambdanoXGr5XZ6ZQiw0NE_bFNhh3sxIQ;LisCustomAccentColorApplied;LgetLastModifiedTimestamp;)V

    return-object v0
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;
    .locals 3
    ...
    .line 3018
    const-class v0, Lcom/bpjstku/data/registration/bpu/remote/BPURegistrationApiClient;
