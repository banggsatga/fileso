...
.method static constructor <clinit>()V
    ...
    .line 16
    new-instance v0, LPlaybackStateCompatErrorCode;

    invoke-direct {v0}, LPlaybackStateCompatErrorCode;-><init>()V
    ...
    .line 16
    sput-object v1, LgetIcon;->b:LaccessisVideoCapture;

    return-void
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/ict/remote/IctApi;
    .locals 1
    ...
    .line 3044
    const-class p1, Lcom/bpjstku/data/ict/remote/IctApiClient;
    ...
    check-cast p0, Lcom/bpjstku/data/ict/remote/IctApiClient;

    .line 3027
    new-instance p1, Lcom/bpjstku/data/ict/remote/IctApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/ict/remote/IctApi;-><init>(Lcom/bpjstku/data/ict/remote/IctApiClient;)V

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/ict/IctRepository;
    .locals 1
    ...
    .line 5048
    const-class p1, Lcom/bpjstku/data/ict/remote/IctApi;
    ...
    check-cast p0, Lcom/bpjstku/data/ict/remote/IctApi;

    .line 5029
    new-instance p1, Lcom/bpjstku/data/ict/IctDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/ict/IctDataStore;-><init>(Lcom/bpjstku/data/ict/remote/IctApi;)V

    check-cast p1, Lcom/bpjstku/data/ict/IctRepository;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/ict/remote/IctApiClient;
    .locals 3
    ...
    .line 1018
    const-class v0, Lcom/bpjstku/data/ict/remote/IctApiClient;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetTouchY;
    .locals 1
    ...
    .line 4052
    const-class p1, Lcom/bpjstku/data/ict/IctRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/ict/IctRepository;

    .line 4031
    new-instance p1, LtoBackEvent;

    invoke-direct {p1, p0}, LtoBackEvent;-><init>(Lcom/bpjstku/data/ict/IctRepository;)V

    check-cast p1, LgetTouchY;
...
.method public static final b()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LgetIcon;->b:LaccessisVideoCapture;
...
.method public static synthetic b(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LgetCustomAction;

    invoke-direct {v0}, LgetCustomAction;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/ict/remote/IctApiClient;
    ...
    .line 6072
    new-instance v0, LPlaybackStateCompatRepeatMode;

    invoke-direct {v0}, LPlaybackStateCompatRepeatMode;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/ict/remote/IctApi;
    ...
    .line 6088
    new-instance v0, LPlaybackStateCompatMediaKeyAction;

    invoke-direct {v0}, LPlaybackStateCompatMediaKeyAction;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/ict/IctRepository;
    ...
    .line 6104
    new-instance v0, LPlaybackStateCompatCustomActionBuilder;

    invoke-direct {v0}, LPlaybackStateCompatCustomActionBuilder;-><init>()V
    ...
    .line 6033
    new-instance v0, LPlaybackStateCompatShuffleMode;

    invoke-direct {v0}, LPlaybackStateCompatShuffleMode;-><init>()V
    ...
    const-class v5, LsetGroupCheckable;
...
.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LsetGroupCheckable;
    .locals 3
    ...
    .line 25033
    new-instance v0, LsetGroupCheckable;

    invoke-direct {v0, p1, v1, p0}, LsetGroupCheckable;-><init>(LgetTouchY;LisCustomAccentColorApplied;LgetLastModifiedTimestamp;)V
