.class public final LHExternalSyntheticLambda1;
...
.method static constructor <clinit>()V
    ...
    .line 16
    sput-object v1, LHExternalSyntheticLambda1;->b:LaccessisVideoCapture;
...
.method public static final TuitionPaymentFragmentbindingInflater1()LaccessisVideoCapture;
    ...
    .line 16
    sget-object v0, LHExternalSyntheticLambda1;->b:LaccessisVideoCapture;

    return-object v0
.end method

.method public static synthetic TuitionPaymentFragmentbindingInflater1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/domain/notification/NotificationUseCase;
    .locals 1
    ...
    .line 21043
    const-class p1, Lcom/bpjstku/data/notification/NotificationRepository;
    ...
    check-cast p0, Lcom/bpjstku/data/notification/NotificationRepository;

    .line 21024
    new-instance p1, LComponentActivityactivityResultRegistry1;

    invoke-direct {p1, p0}, LComponentActivityactivityResultRegistry1;-><init>(Lcom/bpjstku/data/notification/NotificationRepository;)V

    check-cast p1, Lcom/bpjstku/domain/notification/NotificationUseCase;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/notification/remote/NotificationApiClient;
    .locals 3
    ...
    .line 23018
    const-class v0, Lcom/bpjstku/data/notification/remote/NotificationApiClient;

    invoke-static {v0, p1, p0}, LQuirkSettings;->b(Ljava/lang/Class;Lokhttp3/OkHttpClient;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/bpjstku/data/notification/remote/NotificationApiClient;
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault1(LaccessisVideoCapture;)Lkotlin/Unit;
    ...
    new-instance v0, LHExternalSyntheticLambda0;

    invoke-direct {v0}, LHExternalSyntheticLambda0;-><init>()V
    ...
    const-class v3, Lcom/bpjstku/data/notification/remote/NotificationApiClient;
    ...
    .line 2063
    new-instance v0, LonSensorChanged;

    invoke-direct {v0}, LonSensorChanged;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/notification/remote/NotificationApi;
    ...
    .line 2079
    new-instance v0, LHExternalSyntheticLambda2;

    invoke-direct {v0}, LHExternalSyntheticLambda2;-><init>()V
    ...
    const-class v5, Lcom/bpjstku/data/notification/NotificationRepository;
    ...
    const-class v5, Lcom/bpjstku/domain/notification/NotificationUseCase;
    ...
    .line 2026
    new-instance v0, LonLocationChanged;

    invoke-direct {v0}, LonLocationChanged;-><init>()V
...
.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault2(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/notification/NotificationRepository;
    .locals 1
    ...
    .line 25039
    const-class p1, Lcom/bpjstku/data/notification/remote/NotificationApi;
    ...
    check-cast p0, Lcom/bpjstku/data/notification/remote/NotificationApi;

    .line 25022
    new-instance p1, Lcom/bpjstku/data/notification/NotificationDataStore;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/notification/NotificationDataStore;-><init>(Lcom/bpjstku/data/notification/remote/NotificationApi;)V

    check-cast p1, Lcom/bpjstku/data/notification/NotificationRepository;

    return-object p1
.end method

.method public static synthetic TuitionPaymentFragmentspecialinlinedviewModeldefault3(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)Lcom/bpjstku/data/notification/remote/NotificationApi;
    .locals 1
    ...
    .line 22035
    const-class p1, Lcom/bpjstku/data/notification/remote/NotificationApiClient;
    ...
    .line 22020
    new-instance p1, Lcom/bpjstku/data/notification/remote/NotificationApi;

    invoke-direct {p1, p0}, Lcom/bpjstku/data/notification/remote/NotificationApi;-><init>(Lcom/bpjstku/data/notification/remote/NotificationApiClient;)V

    return-object p1
.end method

.method public static synthetic b(LgetOrCreateCameraXInstancelambda18lambda17lambda16lambda15;LaccesssetCameraOperatingMode;)LgetChildTop;
    .locals 4
    ...
    const-class v1, Lcom/bpjstku/domain/notification/NotificationUseCase;
    ...
    check-cast v1, Lcom/bpjstku/domain/notification/NotificationUseCase;
    ...
    .line 1026
    new-instance v0, LgetChildTop;

    invoke-direct {v0, p1, v1, v2, p0}, LgetChildTop;-><init>(LOutputSurface;Lcom/bpjstku/domain/notification/NotificationUseCase;LisCustomAccentColorApplied;LgetLastModifiedTimestamp;)V
